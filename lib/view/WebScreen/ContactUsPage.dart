          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                Container(
                    alignment: Alignment.center,
                    child: Text('About', style: TextStyle(fontWeight: FontWeight.w600, fontSize: ResponsiveWidget.isMediumScreen(context)?20:42, color:  Theme.of(context).canvasColor),)),
                SizedBox(height: 20),
                Padding(
                  padding:  EdgeInsets.only(left: 30,right: 30),
                  child: Text('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularized in the 1960s with the release of Letterset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', style: TextStyle(fontWeight: FontWeight.w400, fontSize: ResponsiveWidget.isMediumScreen(context)?14:22, color:  Theme.of(context).canvasColor)),
                ),
                SizedBox(height: 15,),
                Padding(
                  padding:  EdgeInsets.only(left: 30,right: 30),
  ...
  Widget contactUswidget(var img, String txt){
    return Row(
      children: [
        ...
        SizedBox(width: 10,),
        Text(txt, style: TextStyle(fontWeight: FontWeight.w400, fontSize:ResponsiveWidget.isMediumScreen(context)? 18:38, color: Theme.of(context).canvasColor)),
      ],
    );
  }
}
