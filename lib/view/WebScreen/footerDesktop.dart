        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                AppMediumFont(context,msg:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer egestas dapibus ante, vel", fontSize: 18),
                Row(
                  children: [
                    AppMediumFont(context,msg:"molestie enim tincidunt ac. Aenean erat justo, fringilla cursus ligula ac, accumsan",fontSize: 18)
                    ,
                    Expanded(
                        flex: 1,child: SizedBox(width: MediaQuery.of(context).size.width * .32)),
                    GestureDetector(
                    ...
                    SizedBox(width: MediaQuery.of(context).size.width * .01),
                    GestureDetector(
                        child: Image.asset("images/ic_twitter.png", height: 38,color:Colors.white),
                        onTap: () async {
                          const url =
                ...
                AppMediumFont(context,msg:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer egestas dapibus ante", fontSize: 18),
              ],
            ),
          ) ],
      ),
      ...
      children: [
        ...
        Container(
          ...
          child:AppMediumFont(context,
            msg:'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer egestas dapibus ante, velmolestie enim tincidunt ac. Aenean erat justo, fringilla cursus ligula ac, accumsan Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer egestas dapibus ante'
        ,fontSize: 14  )
        ...
        Row(
          ...
          children: [
            ...
            Column(
              children: [
               AppBoldFont(
                   context,fontWeight: FontWeight.w200,
                    msg: "Connect With Us",
                    fontSize: 16),
                SizedBox(height: 8),
                Row(
