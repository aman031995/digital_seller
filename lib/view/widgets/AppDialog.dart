...
//       title: AppBoldFont(
//           context,msg: isCamera == true ? StringConstant.cameraPer : StringConstant.galleryPer,
//           maxLines: 2,
//           color: TEXT_COLOR,
//           fontSize: 16),
...
//               child: textView(context,title!, 16, WHITE_COLOR),
//             ),
...
//           title: AppBoldFont(context,msg: StringConstant.deleteAccountTitle, fontSize: 22,color: TEXT_COLOR,textAlign: TextAlign.center),
//           titlePadding: EdgeInsets.only(left: 20,right: 20,top: 10),
//           content: AppRegularFont(context,msg: StringConstant.deleteAccountMessage, fontSize: 14,color: TEXT_COLOR,textAlign: TextAlign.center,maxLines: 2),
...
// }
//
// textView(BuildContext context,String msg, double fontSize, Color color) {
//   return Center(
