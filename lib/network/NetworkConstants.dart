...
class NetworkConstants{
  static String kAppBaseUrl = 'https://api.digitalseller.in:8011/api/v1/ecomdh2wy/';
...
//eccommerce
 ...
 static String kReadNotification = 'read-notification?appId={APP_ID}&userId={USER_ID}';
  ...
  static String kSubscribe='add-subscribedEmails';
 ...
 static String kCancelOrder = "cancle-order?userId={USER_ID}&appId={APP_ID}&orderId={ORDER_ID}&orderItemId={ITEM_ID}";
...
static String kOfferList = "offer-product-list?appId={APP_ID}&categoryId={CATEGORY_ID}&userId={USER_ID}&query={QUERY}&pageNum={PAGE_NUM}";




//Chikankari
//static String kAppID='e43d41d1-bcaf-4efa-a326-a5287a7ee4c9';
  //digial SEller Production
